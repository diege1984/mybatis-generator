 ...
 */
package com.wu.common.core.mybatis.comment;
...
import com.wu.common.core.mybatis.time.DateUtils;
 ...
 * @author Jeff Butler
 */
public class WuCommentGenerator implements CommentGenerator {
	...
	public void addClassComment(InnerClass innerClass, IntrospectedTable introspectedTable) {
		...
		innerClass.addJavaDocLine(
				" * " + remarks + " " + innerClass.getType().getShortNameWithoutTypeArguments() + " Class");
		innerClass.addJavaDocLine(" * create time : " + DateUtils.generateTimeStr());
		innerClass.addJavaDocLine(" */"); //$NON-NLS-1$
	}

	public void addInterfaceComment(InnerInterface innerClass, IntrospectedTable introspectedTable) {
		if (suppressAllComments) {
			return;
		}
		String remarks = introspectedTable.getFullyQualifiedTable().getRemark();
	...
	public void addModelClassComment(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
		...
		if (addRemarkComments && StringUtility.stringHasValue(remarks)) {
			...
			topLevelClass.addJavaDocLine(" * create time : " + DateUtils.generateTimeStr());
		}
		topLevelClass.addJavaDocLine(" *"); //$NON-NLS-1$
		topLevelClass.addJavaDocLine(" */"); //$NON-NLS-1$
	}
	...
	public void addFieldComment(Field field, IntrospectedTable introspectedTable) {
		...
		field.addJavaDocLine("/**"); //$NON-NLS-1$
		field.addJavaDocLine(" * auto generator");
		field.addJavaDocLine(" */"); //$NON-NLS-1$
	}
	...
	public void addGeneralMethodComment(Method method, IntrospectedTable introspectedTable) {
		...
		method.addJavaDocLine(" * auto generator");
		method.addJavaDocLine(" */"); //$NON-NLS-1$
	}
