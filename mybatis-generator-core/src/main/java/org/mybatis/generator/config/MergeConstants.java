...
public class MergeConstants {
    ...
    public static final String[] OLD_XML_ELEMENT_PREFIXES = {
            "ibatorgenerated_", "abatorgenerated_","BaseResultMap","Example_Where_Clause","Update_By_Example_Where_Clause"
            ,"Base_Column_List","selectByPrimaryKey","insert"
            ,"insertSelective","countByExample","updateByExampleSelective"
            ,"updateByExample","updateByPrimaryKeySelective","updateByPrimaryKey"
            ,"deleteByExample","deleteByPrimaryKey","selectByExampleWithBLOBs"
            ,"updateByExampleWithBLOBs","updateByPrimaryKeyWithBLOBs","insertBatch"
            ,"MysqlDialectSuffix","OracleDialectSuffix","selectByExample"}; //$NON-NLS-1$ //$NON-NLS-2$
