...
public class ExampleGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        FullyQualifiedJavaType modelType = new FullyQualifiedJavaType(
                "com.wu.common.core.interfaces.IPageModel");
        ...
        constructorMethod.addParameter(new Parameter(modelType, "page"));
        constructorMethod.addBodyLine("oredCriteria = new ArrayList<Criteria>();");
        constructorMethod.addBodyLine("this.offset = (long)(page.getPage() - 1) * page.getPageSize();");
        constructorMethod.addBodyLine("this.limit = this.offset + page.getPageSize();");
        commentGenerator.addGeneralMethodComment(method, introspectedTable);
    ...
    private InnerClass getCriterionInnerClass() {
        ...
        answer.addMethod(getGetter(field1));
        answer.addMethod(getGetter(field2));
        answer.addMethod(getGetter(field3));
        answer.addMethod(getGetter(field4));
        answer.addMethod(getGetter(field5));
        answer.addMethod(getGetter(field6));
        answer.addMethod(getGetter(field7));
        answer.addMethod(getGetter(field8));
        return answer;
    }
