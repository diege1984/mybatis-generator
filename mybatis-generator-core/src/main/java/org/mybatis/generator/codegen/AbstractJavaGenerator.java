...
public abstract class AbstractJavaGenerator extends AbstractGenerator {
	...
	protected FullyQualifiedJavaType getMapper(){
    ...
    protected FullyQualifiedJavaType getDTOType(){
    	return new FullyQualifiedJavaType(introspectedTable.getBaseDTOType());
    }
    ...
    protected FullyQualifiedJavaType getPrimaryType(){
		...
		if (introspectedTable.getRules().generatePrimaryKeyClass()) {
			...
			primaryType = introspectedColumns.get(0).getFullyQualifiedJavaType();
		}
		return primaryType;
    }
}
