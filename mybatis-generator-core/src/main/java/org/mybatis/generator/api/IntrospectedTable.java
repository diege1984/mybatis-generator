...
import org.mybatis.generator.config.JavaDTOGeneratorConfiguration;
...
public abstract class IntrospectedTable {
	...
	protected enum InternalAttribute {
		...
		ATTR_PHYSICAL_DELETE_BY_EXAMPLE_STATEMENT_ID,

		ATTR_LOGIC_DELETE_BY_EXAMPLE_STATEMENT_ID,

		/** The attr delete by primary key statement id. */
		ATTR_DELETE_BY_PRIMARY_KEY_STATEMENT_ID,

		ATTR_PHYSICAL_DELETE_BY_PRIMARY_KEY_STATEMENT_ID,

		ATTR_LOGIC_DELETE_BY_PRIMARY_KEY_STATEMENT_ID,
	...
	public boolean hasVoidFlag(){
		for(IntrospectedColumn column :baseColumns){
			boolean result = column.getActualColumnName().toLowerCase().equals("void_flag");
			if(result){
				return true;
			}
		}
	...
	public String getBaseDTOType() {
		return internalAttributes.get(InternalAttribute.ATTR_BASE_DTO_TYPE);
	}
	...
	public String getBaseServiceImplType() {
		return internalAttributes.get(InternalAttribute.ATTR_BASE_SERVICE_IMPL_TYPE);
	}
	...
	protected void calculateXmlAttributes() {
		...
		setPhysicalDeleteByExampleStatementId("physicalDeleteByExample"); //$NON-NLS-1$
		setPhysicalDeleteByPrimaryKeyStatementId("physicalDeleteByPrimaryKey"); //$NON-NLS-1$

		setLogicDeleteByExampleStatementId("logicDeleteByExample"); //$NON-NLS-1$
		setLogicDeleteByPrimaryKeyStatementId("logicDeleteByPrimaryKey"); //$NON-NLS-1$
	...
	public void setPhysicalDeleteByPrimaryKeyStatementId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_PHYSICAL_DELETE_BY_PRIMARY_KEY_STATEMENT_ID, s);
	}

	public void setLogicDeleteByPrimaryKeyStatementId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_LOGIC_DELETE_BY_PRIMARY_KEY_STATEMENT_ID, s);
	}
	...
	public void setPhysicalDeleteByExampleStatementId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_PHYSICAL_DELETE_BY_EXAMPLE_STATEMENT_ID, s);
	}

	public void setLogicDeleteByExampleStatementId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_LOGIC_DELETE_BY_EXAMPLE_STATEMENT_ID, s);
	}
	 ...
	 */
	public String getPhysicalDeleteByPrimaryKeyStatementId() {
		return internalAttributes.get(InternalAttribute.ATTR_PHYSICAL_DELETE_BY_PRIMARY_KEY_STATEMENT_ID);
	}
	...
	public String getLogicDeleteByPrimaryKeyStatementId() {
		return internalAttributes.get(InternalAttribute.ATTR_LOGIC_DELETE_BY_PRIMARY_KEY_STATEMENT_ID);
	}
	 ...
	 */
	public String getPhysicalDeleteByExampleStatementId() {
		return internalAttributes.get(InternalAttribute.ATTR_PHYSICAL_DELETE_BY_EXAMPLE_STATEMENT_ID);
	}
	...
	public String getLogicDeleteByExampleStatementId() {
		return internalAttributes.get(InternalAttribute.ATTR_LOGIC_DELETE_BY_EXAMPLE_STATEMENT_ID);
	}
	...
	protected String calculateJavaClientInterfacePackage() {
		...
		TableConfiguration tableContext = this.getTableConfiguration();
		...
		StringBuilder sb = new StringBuilder();
		if (stringHasValue(tableContext.getClientTargetPackage())) {
			sb.append(tableContext.getClientTargetPackage());
		} else {
			sb.append(config.getTargetPackage());
		}
	...
	protected String calculateJavaModelPackage() {
		...
		StringBuilder sb = new StringBuilder();
		if (stringHasValue(this.tableConfiguration.getModelTargetPackage())) {
			sb.append(this.tableConfiguration.getModelTargetPackage());
		} else {
			sb.append(config.getTargetPackage());
		}
	 ...
	 * @return the string
	 */
	protected String calculateJavaDTOPackage() {
		JavaDTOGeneratorConfiguration config = context.getJavaDTOGeneratorConfiguration();
		if (config == null) {
			return null;
		}
		StringBuilder sb = new StringBuilder();
		if (stringHasValue(this.tableConfiguration.getDtoTargetPackage())) {
			sb.append(this.tableConfiguration.getDtoTargetPackage());
		} else if (stringHasValue(config.getTargetPackage())) {
			sb.append(config.getTargetPackage());
		} else {
			return null;
		}
	...
	protected String calculateJavaServicePackage() {
		...
		StringBuilder sb = new StringBuilder();
		if (stringHasValue(this.tableConfiguration.getServiceTargetPackage())) {
			sb.append(this.tableConfiguration.getServiceTargetPackage());
		} else if (stringHasValue(config.getTargetPackage())) {
			sb.append(config.getTargetPackage());
		} else {
			return null;
	 ...
	 * Calculate model attributes.
	 */
	protected void calculateDTOAttributes() {
		String pakkage = calculateJavaDTOPackage();
		if (pakkage == null) {
			return;
		}
		StringBuilder sb = new StringBuilder();
	...
	protected void calculateServiceAttributes() {
		...
		setBaseServiceType(sb.toString());

		String pakkageImpl = calculateJavaServicePackage() + ".impl";

		StringBuilder sb1 = new StringBuilder();

		sb1.append(pakkageImpl);
		sb1.append(".");
		sb1.append(fullyQualifiedTable.getDomainObjectName());
		sb1.append("Service");

		setBaseServiceImplType(sb1.toString());
	}
	...
	protected String calculateSqlMapPackage() {
		...
		if (config != null) {
			if (stringHasValue(this.tableConfiguration.getMapTargetPackage())) {
				sb.append(this.tableConfiguration.getMapTargetPackage());
			} else {
				sb.append(config.getTargetPackage());
			}
			sb.append(fullyQualifiedTable.getSubPackageForClientOrSqlMap(isSubPackagesEnabled(config)));
	 ...
	 *            the new base record type
	 */
	public void setBaseDTOType(String baseRecordType) {
		internalAttributes.put(InternalAttribute.ATTR_BASE_DTO_TYPE, baseRecordType);
	}

	public void setBaseServiceType(String baseRecordType) {
		internalAttributes.put(InternalAttribute.ATTR_BASE_SERVICE_TYPE, baseRecordType);
	}

	public void setBaseServiceImplType(String baseRecordType) {
		internalAttributes.put(InternalAttribute.ATTR_BASE_SERVICE_IMPL_TYPE, baseRecordType);
	}
